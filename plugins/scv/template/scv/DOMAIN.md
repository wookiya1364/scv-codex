...
> This document **starts empty**. Codex follows `INTAKE.md` Step 1 plus the `How to elicit` section below to fill it through dialogue with the user. Don't speculate without the user's explicit answer.
...
5. **Use cases**: "List the 3–7 most important user actions in this system as **observable sequences**." (UC codes assigned by Codex)
...
After each answer, Codex must confirm with **"Shall I record it like this?"** before moving to the next question.
