---
name: update
description: "Compare the installed SCV Codex plugin with its latest release and guide a safe marketplace refresh and reinstall. Use when the user asks to update SCV, check its version, or invokes $scv:update."
---
