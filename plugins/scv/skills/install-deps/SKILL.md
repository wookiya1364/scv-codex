---
name: install-deps
description: "Detect missing command-line dependencies used by SCV and provide platform-specific installation commands. Use when an SCV helper reports a missing tool or the user invokes $scv:install-deps."
---
