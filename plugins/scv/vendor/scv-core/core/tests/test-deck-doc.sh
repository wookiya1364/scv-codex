...
#  13. ```screen fenced JSON → wireframe mockup (Codex-authored, per commands/promote.md
...
#     tokens only when told, 2순위=scv skin otherwise); Codex supplies base hex only,
