#!/usr/bin/env bash
scv='$scv'
# test-help-workspace.sh — $scv:help is workspace-aware (CHILD/ROOT), silent for single.
...
echo "── $scv:help workspace-awareness ──"
...
has  'CHILD: recommends $scv:promote'         "$CHILD_OUT" '$scv:promote'
